{{-- Recognitions --}}
<section class="recognitions pt-4 pb-4">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="recognitions-item">
                        <img src="assets/img/Recognitions/Adventure-Tour-Operators-Association-Of-India.png" width="" height="" class="img-fluid" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="recognitions-item">
                        <img src="assets/img/Recognitions/CII–Confederation-Of-Indian-Industry.png" width="" height="" class="img-fluid" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="recognitions-item">
                        <img src="assets/img/Recognitions/DGCA.png" width="" height="" class="img-fluid" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="recognitions-item">
                        <img src="assets/img/Recognitions/IATO.png" width="" height="" class="img-fluid" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="recognitions-item">
            ...
            <div class="col-md-5 mb-4">
                <div class="footer-item">
                    <div class="footer-logo">
                        ...
                        {{-- <p class="text-center mb-0"><img style="max-width: 100%" src="assets/img/msme.png" alt="Torna Holidays Pvt Ltd" width="100%" height="" /></p> --}}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="footer-item">
                    ...
                    <div class="footer-contact">
                        ...
                        <div class="footer-item pb-3">
                            <label>Address:</label>
                            <p class="text-justify">S 15, Malhan Falcon Plaza, Plot No. 4, Pocket 7, Dwarka Sector 12, New Delhi - 110078</p>
                        </div>
                    </div>
                </div>
            </div>
