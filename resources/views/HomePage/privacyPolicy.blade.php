...
@section('content')
    <div class="information-page-slider">
        <img src="assets/img/travel-with-landmarks-new.png" alt="Torna Holidays Pvt Ltd" class="img-fluid">
        ...
        <div class="default-content pt-5 pb-3">
            <div class="custom-container">
                ...
                <div class="midd-content">
                    ...
                    <p class="text-justify"><b>Torna Holidays Pvt Ltd</b> may change this Policy periodically and we urge you to check this page for the latest version of the Policy in order to keep yourself updated.</p>
                    ...
                    <p class="text-justify"><b><i>Withdrawal of your Consent</i></b> - You can choose not to provide your data, at any time while availing our goods or services or otherwise withdraw your consent provided to us earlier, in writing to our email ID: <a href="mailto:tornaholidays@gmail.com">tornaholidays@gmail.com</a> In the event you choose to not provide or later withdraw your consent, we may not be able to provide you our services or goods.Please note that these rights are subject to our compliance with applicable laws.</p>
                ...
                <div class="midd-content">
                    ...
                    <p class="text-justify"><b>Torna Holidays Pvt Ltd</b> is not liable for any delay in delivery by the courier company / postal authorities and only guarantees to hand over the consignment to the courier company or postal authorities within 3-5 Days days from the date of the order and payment or as per the delivery date agreed at the time of order confirmation. Delivery of all orders will be to the address provided by the buyer. Delivery of our services will be confirmed on your mail ID as specified during registration. For any issues in utilizing our services you may contact our helpdesk on <a href="tel:+919540721363">+91 954 072 1363</a> or <a href="mailto:tornaholidays@gmail.com">tornaholidays@gmail.com</a>.</p>
                </div>
            </div>
        </div>
    </div>
